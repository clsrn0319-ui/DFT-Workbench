...
export const DICTIONARY: DictEntry[] = [
  ...
  {
    dictId: 'cnf-glucose',
    name: 'Anhydroglucose (CNF/cellulose unit)',
    korName: '무수글루코스 단위 (CNF/셀룰로스)',
    casNo: '',
    smiles: 'OCC1OC(O)C(O)C(O)C1O',
    formula: 'C6H12O6',
    mw: 180.16,
    type: '바인더 모노머',
    synonyms: ['CNF', 'cellulose nanofiber', 'AGU', 'β-1,4-glucose'],
    functionalGroups: ['하이드록실 –OH ×5', '에테르 고리(피라노스)'],
    trends: [
      '치환기 없는 순수 셀룰로스 반복단위 — 다중 –OH의 조밀한 H-bond 네트워크',
      '높은 결정성·강직한 나노섬유 골격 (CMC 대비 카복실기 없음 → 이온화 없음)',
      '수소결합 기반 강한 자기응집·표면 흡착 가능성',
    ],
    cautions: [
      'CNF의 결정성·섬유 종횡비·표면적 등 나노구조 물성은 단위 구조로 확정 불가',
      'TEMPO 산화 CNF는 표면에 카복실기 도입 — 별도 화학종으로 계산 필요',
    ],
    ency: {
      state: '백색 고체 / 수분산 겔·필름 (CNF)',
      solubility: '물·일반 유기용매에 불용 (강한 분자간 H-bond) — 수분산 형태로 사용',
      acidBase: '중성 — 이온화 작용기 없음 (카복실기 없는 순수 셀룰로스)',
      reactivity: '산 가수분해로 글루코스 단위 분해. TEMPO 산화·카복시메틸화로 표면 관능화',
      isomers: 'β-1,4 결합 (셀룰로스) vs α-1,4 (녹말); 글루코스 α/β 아노머, 다수 카이랄 중심',
      optical: '무색 · 카이랄 중심 5개 (D-글루코스 유래) — 광학 활성 · 반자성',
      extra: [
        'CMC와의 차이: CMC = 이 글루코스 단위의 –OH 일부가 –OCH₂COOH(카복시메틸)로 치환된 유도체',
        '수계 음극 바인더 — SBR 등과 병용해 유연성 보완',
      ],
    },
    base: { homo: -7.34, lumo: 0.63, dipole: 3.12, alpha: 108.6, liBind: -126, hbd: 5, hba: 6 },
  },
  {
    dictId: 'mma',
